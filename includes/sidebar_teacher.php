...
function navActiveT(string $path): string {
    global $cp;
...
?>
<style>
:root { --ns-role-primary: #059669; --ns-role-accent: #10B981; }
</style>
<aside id="app-sidebar"
    ...
    <div class="relative flex h-16 items-center gap-3 border-b border-mist px-6">
        ...
        <div class="min-w-0 leading-tight">
            ...
            <p class="text-[11px] font-medium uppercase tracking-[0.12em] text-zinc-400">Guru&nbsp;· <?= htmlspecialchars(ACADEMIC_YEAR) ?></p>
        </div>
    </div>
    ...
    <nav class="flex-1 px-4 py-6 overflow-y-auto space-y-1">
        ...
        <a href="<?= BASE_URL ?>/pages/teacher/dashboard.php"
           class="flex items-center gap-2.5 px-3 py-2 rounded-lg font-medium transition-colors <?= navActiveT('/teacher/dashboard') ?>">
        ...
        <a href="<?= BASE_URL ?>/pages/teacher/grades/index.php"
           class="flex items-center gap-2.5 px-3 py-2 rounded-lg font-medium transition-colors <?= navActiveT('/teacher/grades') ?>">
            <svg class="ns-nav-link-icon size-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="<?= BASE_URL ?>/pages/teacher/attendance/index.php"
           class="flex items-center gap-2.5 px-3 py-2 rounded-lg font-medium transition-colors <?= navActiveT('/teacher/attendance') ?>">
            <svg class="ns-nav-link-icon size-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="<?= BASE_URL ?>/pages/teacher/academic_calendar.php"
           class="flex items-center gap-2.5 px-3 py-2 rounded-lg font-medium transition-colors <?= navActiveT('/teacher/academic_calendar') ?>">
            <svg class="ns-nav-link-icon size-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="<?= BASE_URL ?>/pages/teacher/profile.php"
           class="flex items-center gap-2.5 px-3 py-2 rounded-lg font-medium transition-colors <?= navActiveT('/teacher/profile') ?>">
            <svg class="ns-nav-link-icon size-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <a href="<?= BASE_URL ?>/pages/teacher/profile.php"
       ...
       aria-label="Buka profil">
        ...
        <div class="min-w-0 flex-1 leading-tight">
            ...
            <p class="truncate text-[11px] text-zinc-400">Guru</p>
        </div>

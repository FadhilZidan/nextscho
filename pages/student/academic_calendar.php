...
$breadcrumb = [['label' => 'Siswa'], ['label' => 'Kalender Akademik']];
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="ns-table-wrap">
                ...
                ?>
                <div style="padding:10px 24px;background:rgba(225,29,72,0.04);border-bottom:1px solid #F1F0EB;">
                    <p style="font-size:11px;font-weight:700;letter-spacing:0.10em;text-transform:uppercase;color:#E11D48;">
                        <?= $monthLabel ?>
                    </p>
                </div>
        ...
        <div>
            <div class="ns-glass-panel overflow-hidden" style="position:sticky;top:80px;">
                <div style="padding:16px 20px;border-bottom:1px solid rgba(0,0,0,0.06);display:flex;align-items:center;gap:10px;">
                    <div style="width:32px;height:32px;border-radius:10px;background:#FFF1F2;display:flex;align-items:center;justify-content:center;">
                ...
                <div style="padding:8px;">
                    ...
                    <div style="padding:12px;border-radius:10px;margin-bottom:4px;transition:background 0.15s;"
                        ...
                        <div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;">
                            ...
                            <?php if ($daysLeft === 0): ?>
                            <span style="font-size:10px;color:#E11D48;font-weight:600;">Hari ini</span>
